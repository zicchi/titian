<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{request()->is('admin/abouts*') ? 'active' : ''}}"><a class="nav-link" href="{{route('admin::abouts::index')}}"><i class="fas fa-chair"></i> <span>Abouts</span></a></li>
            ...
            <li class="{{request()->is('admin/galleries*') ? 'active' : ''}}"><a class="nav-link" href="{{route('admin::galleries::index')}}"><i class="fas fa-newspaper"></i> <span>Gallery</span></a></li>
            ...
            <li class="{{request()->is('admin/faqs*') ? 'active' : ''}}"><a class="nav-link" href="{{route('admin::clients::index')}}"><i class="fas fa-question"></i> <span>Client</span></a></li>
