              ...
              <div class="dropdown-menu w-215px p-2 border-0 dropdown-menu-right rounded-0">
                <a href="product-page-01.html" class="media align-items-center">
                  <div class="w-60px mr-2">
                    <img src="{{ asset('assets/images/product-08.jpg') }}"
                                   alt="Bow Chair">
                  </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-7 mb-6 mb-md-0 pr-md-6 pr-lg-9">
            <div class="galleries position-relative">
              ...
              <div class="slick-slider slider-for"
                ...
                <div class="box">
                  <div class="card p-0 hover-change-image rounded-0 border-0">
                    <a href="{{ asset('assets/images/product-page-13.jpg') }}"
                                 class="card-img ratio ratio-1-1 bg-img-cover-center"
                                 data-gtf-mfp="true"
                                 data-gallery-id="02"
                                 style="background-image:url('{{ asset('assets/images/product-page-13.jpg') }}')">
                    </a>
                  </div>
                </div>
                <div class="box">
                ...
                <div class="box">
                  <div class="card p-0 hover-change-image rounded-0 border-0">
                    <a href="images/product-page-16.jpg"
                                 ...
                                 data-gtf-mfp="true"
                                 data-gallery-id="02"
                                 style="background-image:url('{{ asset('assets/images/product-page-16.jpg') }}')">
                    </a>
                  </div>
                </div>
                <div class="box">
                  <div class="card p-0 hover-change-image rounded-0 border-0">
                    <a href="images/product-page-14.jpg"
                                 ...
                                 data-gtf-mfp="true"
                                 data-gallery-id="02"
                                 style="background-image:url('{{ asset('assets/images/product-page-14.jpg') }}')">
                    </a>
                  </div>
                </div>
              </div>
              <div class="slick-slider slider-nav mt-1 mx-n1"
                ...
                <div class="box px-0">
                  <div class="bg-white p-1 h-100 rounded-0">
                    <img src="{{ asset('assets/images/product-page-15.jpg') }}" alt="Image 2"
                                   class="h-100 w-100">
                  </div>
                </div>
                <div class="box px-0">
                  <div class="bg-white p-1 h-100 rounded-0">
                    <img src="{{ asset('assets/images/product-page-16.jpg') }}" alt="Image 3"
                                   class="h-100 w-100">
                  </div>
                </div>
                <div class="box px-0">
                  <div class="bg-white p-1 h-100 rounded-0">
                    <img src="{{ asset('assets/images/product-page-14.jpg') }}" alt="Image 4"
                                   class="h-100 w-100">
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-5">
            ...
            <p class="mb-4 d-flex text-primary">
              ...
              <span class="fs-15">Only <span class="font-weight-600">11</span> Left in Stock</span>
            </p>
            <p class="mb-5">{{ $product->description }}</p>
            <img class="border mb-6" src="{{ asset('assets/images/product-page-09.jpg') }}"
                   alt="Image Product">
            <form>
              ...
              <ul class="list-inline px-xl-8 mb-4 d-flex align-items-center justify-content-center">
                <li class="list-inline-item mr-5">
                  <img class="" src="{{ asset('assets/images/p1.png') }}"
                               alt="Visa">
                </li>
                <li class="list-inline-item mr-5">
                  <img class="" src="{{ asset('assets/images/p2.png') }}"
                               alt="Visa">
                </li>
                <li class="list-inline-item mr-5">
                  <img class="" src="{{ asset('assets/images/p3.png') }}"
                               alt="Visa">
                </li>
                <li class="list-inline-item mr-5">
                  <img class="" src="{{ asset('assets/images/p4.png') }}"
                               alt="Visa">
                </li>
                <li class="list-inline-item mr-5">
                  <img class="" src="{{ asset('assets/images/p5.png') }}"
                               alt="Visa">
                </li>
              </ul>
            </form>
                  ...
                  <div id="description-collapse-01" class="collapsible collapse show"
                    ...
                    <div id="accordion-style-01"
                      ...
                      <div class="text-center pt-md-7">
                        <img src="{{ asset('assets/images/description-product.jpg') }}"
                      ...
                      <div class="mxw-830 mx-auto pt-md-4">
                        ...
                        <div class="row">
                          <div class="col-sm-3 col-md-2 mb-6 mb-sm-0">
                            <img class="border"
                                                   src="{{ asset('assets/images/product-page-09.jpg') }}"
                                                   alt="Image Product">
                          </div>
                      ...
                      <div class="comment-product mxw-830 mx-auto pt-md-4">
                        ...
                        <div class="media border-bottom pb-6 mb-6 ">
                          <div class="w-70px d-block mr-6">
                            <img src="{{ asset('assets/images/tes_01.png') }}"
                                                   alt="Dean. D">
                          </div>
                          <div class="media-body">
                            ...
                            <p class="text-gray-01 lh-175 mb-2">It has a really nice fit however it loses many fluffs and is kind of see-through because the fabric is quite wid-meshed. Nevertheless it's a really good and comfy staple that goes with every kind.</p>
                            <span class="font-weight-600 text-primary d-block">Dean. D</span>
                          </div>
                        </div>
                        <div class="media border-bottom pb-6 mb-6 ">
                          <div class="w-70px d-block mr-6">
                            <img src="{{ asset('assets/images/tes_02.png') }}"
                                                   alt="Dean. D">
                          </div>
                          <div class="media-body">
                            <div class="row no-gutters mb-2 align-items-center rating-result">
                        ...
                        <div class="media ">
                          <div class="w-70px d-block mr-6">
                            <img src="{{ asset('assets/images/tes_03.png') }}"
                                                   alt="Dean. D">
                          </div>
                          <div class="media-body">
                            <div class="row no-gutters mb-2 align-items-center rating-result">
        ...
        <div class="slick-slider"
          ...
          <div class="box">
            <div class="card border-0 hover-change-content product">
              <div style="background-image: url('{{ asset('assts/images/product-16.jpg')"
          ...
          <div class="box">
            <div class="card border-0 hover-change-content product">
              <div style="background-image: url('{{ asset('assts/images/product-04.jpg')"
                       class="card-img ratio bg-img-cover-center ratio-1-1">
              </div>
              <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                <div class="d-flex flex-column">
          ...
          <div class="box">
            <div class="card border-0 hover-change-content product">
              <div style="background-image: url('{{ asset('assts/images/product-06.jpg')"
                       class="card-img ratio bg-img-cover-center ratio-1-1">
              </div>
              <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                <div class="d-flex flex-column">
          ...
          <div class="box">
            <div class="card border-0 hover-change-content product">
              <div style="background-image: url('{{ asset('assts/images/product-05.jpg')"
                       class="card-img ratio bg-img-cover-center ratio-1-1">
              </div>
              <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                <div class="d-flex flex-column">
          ...
          <div class="box">
            <div class="card border-0 hover-change-content product">
              <div style="background-image: url('{{ asset('assts/images/product-26.jpg')"
                       class="card-img ratio bg-img-cover-center ratio-1-1">
              </div>
              <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                <div class="d-flex flex-column">
