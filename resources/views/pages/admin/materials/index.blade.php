        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('admin::materials::create')}}" class="btn btn-primary">Tambah Material +</a>
                </div>
                            ...
                            @foreach($materials as $material)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin::materials::destroy', [$material]) }}" method="post" class="hidden" id="delete-item-{{ $material->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </td>
